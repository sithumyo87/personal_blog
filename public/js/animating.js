var PageTransitions = (function ($, options) {
    ...
    function init(options) {
        ...
        sectionsContainer.each(function () {
            if (location.hash === "") {
                $("section[data-id=" + pageStart + "]").addClass(
                    "section-active"
                );
            }
        });
    ...
    function ajaxLoader() {
        ...
        function showContent() {
            ajaxLoadedContent.removeClass(
                "animated-section-moveToRight closed"
            );
            ajaxLoadedContent.show();
            $("body").addClass("ajax-page-visible");
        }
        function hideContent() {
            $("#page-ajax-loaded").addClass(
                "animated-section-moveToRight closed"
            );
    ...
    function Animate($pageTrigger, gotoPage) {
        ...
        if (animation.indexOf("-") != -1) {
            ...
            selectedAnimNumber = parseInt(
                randomAnimList[
                    Math.floor(Math.random() * randomAnimList.length)
                ]
            );
        } else {
        ...
        switch (selectedAnimNumber) {
            ...
            case 24:
                inClass = "animated-section-scaleUp";
                outClass =
                    "animated-section-moveToRight animated-section-ontop";
                break;
            case 25:
                inClass = "animated-section-scaleUp";
            ...
            case 26:
                inClass = "animated-section-scaleUp";
                outClass =
                    "animated-section-moveToBottom animated-section-ontop";
                break;
            case 27:
                inClass =
